...
public class EmployeesEntityImpl extends EntityImpl {
    ...
    public static final int MANAGERIDEMPLOYEESENTITY = AttributesEnum.ManagerIdEmployeesEntity.index();
    public static final int DEPARTMENTSENTITY = AttributesEnum.DepartmentsEntity.index();
    public static final int DEPARTMENTSENTITY1 = AttributesEnum.DepartmentsEntity1.index();

    /**
     * This is the default constructor (do not remove).
     */
    public EmployeesEntityImpl() {
    }
    ...
    /**
     * @return the associated entity EmployeesEntityImpl.
     */
    public EmployeesEntityImpl getManagerIdEmployeesEntity() {
        return (EmployeesEntityImpl) getAttributeInternal(MANAGERIDEMPLOYEESENTITY);
    }

    /**
     * Sets <code>value</code> as the associated entity EmployeesEntityImpl.
     */
    public void setManagerIdEmployeesEntity(EmployeesEntityImpl value) {
        setAttributeInternal(MANAGERIDEMPLOYEESENTITY, value);
    }

    /**
     * @return the associated entity DepartmentsEntityImpl.
     */
    public DepartmentsEntityImpl getDepartmentsEntity() {
        return (DepartmentsEntityImpl) getAttributeInternal(DEPARTMENTSENTITY);
    }

    /**
     * Sets <code>value</code> as the associated entity DepartmentsEntityImpl.
     */
    public void setDepartmentsEntity(DepartmentsEntityImpl value) {
        setAttributeInternal(DEPARTMENTSENTITY, value);
    }

    /**
     * @return the associated entity oracle.jbo.RowIterator.
     */
    public RowIterator getDepartmentsEntity1() {
        return (RowIterator) getAttributeInternal(DEPARTMENTSENTITY1);
    }
